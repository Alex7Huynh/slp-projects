...
namespace Lab2
{
    public static class ConstantValues
    {
        ...
        public const string CMD_TEST_STEP1_CREATEMFCC = "HTKProgram\\HCopy -T 1 -C config\\config.hcopy -S mfcc-test.scp";
        public const string CMD_TEST_STEP1_PARSEGRAM = "HTKProgram\\HParse config\\gram.txt wdnet";
        ...
        public const string CMD_TEST_RESULT = "HTKProgram\\HResults -I test.mlf tiedlist recout.mlf";
    }
}
